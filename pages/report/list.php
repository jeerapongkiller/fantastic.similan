                                                ...
                                                <tbody>
                                                    <?php for ($i = 0; $i < count($bo_id); $i++) { ?>
                                                        <tr>
                                                            ...
                                                            <td><?php echo !empty($tourist_max[$bo_id[$i]]) ? array_sum($tourist_max[$bo_id[$i]]) : 0; ?></td>
                                        ...
                                        <table class="table table-striped text-uppercase table-vouchure-t2">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                        <tr>
                                                            <td>
                                                                <div class="font-weight-bolder text-primary"><?php echo !empty($car_name[$x]) ? !empty($driver_name[$x]) ? $car_name[$x] . ' / ' . $driver_name[$x] : $car_name[$x] : ''; ?></div>
                                                            </td>
                                                            <td><?php echo (!empty($ortran_travel[$x])) ? date('j F Y', strtotime($ortran_travel[$x])) : ''; ?></td>
                                                            <td class="text-center"><?php echo !empty($bot_id[$val]) ? count($bot_id[$val]) : 0; ?></td>
                                                            <td class="text-center"><?php echo $adult_car; ?></td>
                                                            <td class="text-center"><?php echo $child_car; ?></td>
                                                            <td class="text-center"><?php echo $infant_car; ?></td>
                                                            <td class="text-center"><?php echo $foc_car; ?></td>
                                                            <td class="text-center"><?php echo $tourist_car; ?></td>
                                                            <td class="text-center"><?php echo !empty($tourist[$val]) ? array_sum($tourist[$val]) : 0; ?></td>
                                                        </tr>
                                                <?php }
                                                } ?>
                                            </tbody>
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                        <tr>
                                                            ...
                                                            <td class="text-center"><?php echo $adult_boat; ?></td>
                                                            <td class="text-center"><?php echo $child_boat; ?></td>
                                                            <td class="text-center"><?php echo $infant_boat; ?></td>
                                                            <td class="text-center"><?php echo $foc_boat; ?></td>
                                                            <td class="text-center"><?php echo $tourist_boat; ?></td>
                                                        </tr>
                                                <?php }
                                                } ?>
                                            </tbody>
