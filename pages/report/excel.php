...
if (isset($_GET['action']) && $_GET['action'] == "print" && isset($_GET['type'])) {
    ...
    foreach ($bookings as $booking) {
        ...
        if (in_array($booking['id'], $first_book) == false) {
            ...
            $status[] = !empty($booking['booksta_name']) ? $booking['booksta_name'] : '';
            ...
            # --- get value booking products --- #
            $hotel_pickup_name[] = !empty($booking['hotel_pickup_id']) ? $booking['hotel_pickup_name'] : $booking['hotel_pickup'];
            $hotel_dropoff_name[] = !empty($booking['hotel_dropoff_id']) ? $booking['hotel_dropoff_name'] : $booking['hotel_dropoff'];
            # --- get value customers --- #
