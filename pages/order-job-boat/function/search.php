...
if (isset($_POST['action']) && $_POST['action'] == "search") {
    ...
    # --- get data --- #
    $orders = $orderObj->showlistboat('job', $search_period, $date_travel_form, $search_product, 'all', 'all', 'all', 'all');
    if (!empty($orders)) {
...
?>
        <div class="content-header">
            <div class="pl-1 pt-0 pb-0">
                ...
                <!-- <a href="./?pages=order-job/excel&action=excel&<?php echo 'search_period=' . $search_period; ?>&<?php echo 'search_product=' . $search_product; ?>&<?php echo 'date_travel_form=' . $date_travel_form; ?>" target="_blank" class="btn btn-info">Excel</a> -->
                    ...
                    <div class="card-body pb-0 pt-0">
                        <div class="row card-text align-items-center">
                            ...
                            <div class="col-md-3 text-right">
                                <input type="hidden" class="job-head<?php echo $orboat_id[$i]; ?>" data-product="<?php echo $product_name[$orboat_id[$i]][0] . ' (' . $booking_type[$orboat_id[$i]][0] . ')'; ?>" data-boat="<?php echo $order_boat_name[$i] . ' (' . $order_boat_refcode[$i] . ')'; ?>" data-date="<?php echo date('j F Y', strtotime($date_travel_form)); ?>">
