...
if (isset($_POST['action']) && $_POST['action'] == "search") {
    ...
    $name_img = '';
    # --- get data --- #
    $orders = $orderObj->showlisttransfers('order', 1, 0, $search_period_driver, $date_travel_driver, 'all', $search_car, $search_trans_type, 'all');
    if (!empty($orders)) {
...
?>
    <div class="content-header">
        <div class="pl-1">
            <a href="./?pages=order-pickup/print&action=print&search_period_driver=<?php echo $search_period_driver; ?>&date_travel_driver=<?php echo $date_travel_driver; ?>&search_car=<?php echo $search_car; ?>&search_trans_type=<?php echo $search_trans_type; ?>" target="_blank" class="btn btn-info">Print</a>
