                                            ...
                                            <tbody>
                                                <?php for ($i = 0; $i < count($agent_id); $i++) {  ?>
                                                    <tr>
                                                        ...
                                                        <td class="text-nowrap text-center font-weight-bolder">
                                                            <div class="d-flex flex-column">
                                                                <span class="font-weight-bolder mb-25 text-danger"><?php echo !empty($comp_amount[$agent_id[$i]]) && !empty($comp_revenue[$agent_id[$i]]) ? number_format(array_sum($comp_amount[$agent_id[$i]]) - array_sum($comp_revenue[$agent_id[$i]])) : 0; ?></span>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                <?php } ?>
