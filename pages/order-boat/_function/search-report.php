        ...
        ?>
                <div class="row text-center mx-0">
                    <div class="col-4 border-top border-right text-left py-50 pb-1">
                        ...
                        <a href="./?pages=order-boat/list&date_travel_booking=<?php echo $_POST['date']; ?>&manage_id=<?php echo $manage_id[$i]; ?>">
                    ...
                    <div class="col-2 border-top border-right py-50 pb-1">
                        ...
                        <h4 class="font-weight-bolder mb-0"><?php echo !empty($bo_id[$manage_id[$i]]) ? count($bo_id[$manage_id[$i]]) : 0; ?></h4>
                    </div>
                    <div class="col-2 border-top border-right py-50 pb-1">
                        <small class="card-text text-muted mb-0">Total</small>
                        <h4 class="font-weight-bolder mb-0"><?php echo !empty($tourist[$manage_id[$i]]) ? array_sum($tourist[$manage_id[$i]]) : 0; ?></h4>
                    </div>
