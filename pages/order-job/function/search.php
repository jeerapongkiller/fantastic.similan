...
if (isset($_POST['action']) && $_POST['action'] == "search") {
    ...
    $search_boat_name = $search_boat != 'all' ? $orderObj->get_data('name', 'products', $search_boat)['name'] : '';
    ...
    # --- get data --- #
    $orders = $orderObj->showlistboats('list', 0, $date_travel_form, $search_boat, 'all');
    if (!empty($orders)) {
...
?>
        <div class="content-header">
            <div class="pl-1 pt-0 pb-0">
                <a href="./?pages=order-job/print&action=print&<?php echo 'search_period=' . $search_period; ?>&<?php echo 'search_boat=' . $search_boat; ?>&<?php echo 'date_travel_form=' . $date_travel_form; ?>" target="_blank" class="btn btn-info">Print</a>
