...
?>
    <style>
        ...
        .invoice-padding .table-black td {
            color: #FFFFFF;
            background-color: <?php echo ($all_invocies[0]['vat_id'] > 0) ? '#960007ff' : '#003285'; ?>;
            padding: 0.7rem;
        }

        .invoice-padding .table-black-2 td {
            color: #FFFFFF;
            background-color: <?php echo ($all_invocies[0]['vat_id'] > 0) ? '#ff3f49ff' : '#0060ff'; ?>;
            padding: 0.5rem;
        }
    ...
    <div class="card-body invoice-padding pb-0" id="invoice-preview-vertical">
            ...
            <div class="col-6 text-right mt-md-0 mt-2">
                ...
                <table width="100%" class="mt-50" hidden>
                    <tr class="table-content">
                        <th rowspan="2" class="text-center" bgcolor="<?php echo ($all_invocies[0]['vat_id'] > 0) ? '#960007ff' : '#003285'; ?>" style="color: #fff; border-radius: 15px 0px 0px 0px;">
                            ใบแจ้งหนี้ / INVOICE
                        </th>
        ...
        <table width="100%" class="mt-1">
            ...
            <tr class="table-content">
                <!-- <td colspan="9"></td> -->
                <td class="text-center" style="color: #fff; background-color: <?php echo ($all_invocies[0]['vat_id'] > 0) ? '#960007ff' : '#003285'; ?>;" colspan="4">
                    <dl class="row" style="margin-bottom: 0;">
                        <dt class="col-sm-8 text-right">
                            <b>ยอดชำระ : </b>
