...
if (isset($_SESSION["supplier"]["role_id"])) {
    echo $_SESSION["supplier"]["role_id"] > 2 ? header('location:./?pages=car/list') : '';
}
?>
...
<head>
    ...
    <title>Cars - <?php echo $main_title; ?></title>
            ...
            if (jqForm.length) {
                ...
                jqForm.validate({
                    ...
                    submitHandler: function(form) {
                        ...
                        $.ajax({
                            url: "pages/car/function/create.php",
                            type: "POST",
                            ...
                            success: function(response) {
                                if (response != false && response > 0) {
                                    Swal.fire({
                                        ...
                                        if (isConfirm) {
                                            window.location.href = './?pages=car/edit&id=' + response; // refresh page
                                        }
                                    });
                                } else {
                                    Swal.fire({
                ...
                $('#category').change(function() {
                    ...
                    $.ajax({
                        url: "pages/car/function/change-category.php",
                        type: "POST",
                        data: serializedData + "&action=create",
                        success: function(response) {
