...
if (isset($_SESSION["supplier"]["id"]) && $_SESSION["supplier"]["role_id"] > 2) {
    echo $_GET['id'] != $_SESSION["supplier"]["id"] ? header('location:./?pages=car-category/list') : '';
}
?>
...
<head>
    ...
    <title>Cars Category - <?php echo $main_title; ?></title>
...
<body class="vertical-layout vertical-menu-modern navbar-floating footer-static menu-collapsed pace-done" data-open="click" data-menu="vertical-menu-modern" data-col="">
    ...
    <script type="text/javascript">
        // Ajax Delete Car-category
        // --------------------------------------------------------------------
        function deleteCarCategory(car_category_id) {
            Swal.fire({
                title: 'Are you sure?',
                ...
                if (result.value) {
                    $.ajax({
                        url: "pages/car-category/function/delete.php",
                        type: "POST",
                        data: {
                        ...
                        success: function(response) {
                            if (response != false) {
                                Swal.fire({
                                    ...
                                    location.href = './?pages=car-category/list';
                                });
                            } else {
                                Swal.fire({
                                    icon: 'error',
        ...
        $(document).ready(function() {
            var jqForm = $('#car-category-edit-form'),
                picker = $('#dob'),
                ...
                jqForm.validate({
                    rules: {
                        'name': {
                            ...
                            regex: /^[a-zA-Z0-9]/,
                            remote: {
                                url: "pages/car-category/function/check-name.php",
                                type: "post",
                                data: {
                                    car_category_id: function() {
                                        return $("#car_category_id").val();
                                    }
                                }
                            }
                        },
                    ...
                    submitHandler: function(form) {
                        ...
                        $.ajax({
                            url: "pages/car-category/function/edit.php",
                            type: "POST",
