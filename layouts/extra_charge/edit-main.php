    ...
    <script type="text/javascript">
        ...
        function deleteExtraCharge(extra_id) {
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        url: "pages/extra_charge/function/delete.php",
                        type: "POST",
                        data: {
                            extra_id: extra_id,
                            action: 'delete'
                        ...
                        success: function(response) {
                            if (response != false) {
                                Swal.fire({
                                    ...
                                    location.href = './?pages=extra_charge/list';
                                });
                            } else {
                                Swal.fire({
                                    icon: 'error',
        ...
        $(document).ready(function() {
            var jqForm = $('#extra-charge-edit-form'),
            ...
            if (jqForm.length) {
                ...
                jqForm.validate({
                    ...
                    submitHandler: function(form) {
                        ...
                        $.ajax({
                            url: "pages/extra_charge/function/edit.php",
                            type: "POST",
                            processData: false,
                            contentType: false,
                            data: formData,
