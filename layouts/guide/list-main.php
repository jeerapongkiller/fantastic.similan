<head>
    ...
    <title>Guide - <?php echo $main_title; ?></title>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('.guide-list-table').DataTable({
                ...
                buttons: [{
                    ...
                    action: function(api, node, config) {
                        window.location.href = './?pages=guide/create';
                    }
                }],
                language: {
                    paginate: {
            ...
            jqForm.on("submit", function(e) {
                ...
                $.ajax({
                    url: "pages/guide/function/search.php",
                    type: "POST",
                    data: serializedData + "&action=search",
                    success: function(response) {
                        if (response != false) {
                            $("#guide-search-table").html(response);
