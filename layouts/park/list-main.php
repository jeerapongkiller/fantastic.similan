<head>
    ...
    <title>Park - <?php echo $main_title; ?></title>
    ...
    <script type="text/javascript">
        ...
        function deletePlace(park_id) {
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        url: "pages/park/function/delete.php",
                        type: "POST",
                        data: {
                            park_id: park_id,
                            action: 'delete'
        ...
        $(document).ready(function() {
            $('.place-list-table').DataTable({
                ...
                buttons: [{
                    ...
                    action: function(api, node, config) {
                        window.location.href = './?pages=park/create';
                    }
                }],
                language: {
                    paginate: {
            ...
            jqForm.on("submit", function(e) {
                ...
                $.ajax({
                    url: "pages/park/function/search.php",
                    type: "POST",
