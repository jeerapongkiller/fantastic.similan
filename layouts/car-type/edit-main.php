...
if (isset($_SESSION["supplier"]["id"]) && $_SESSION["supplier"]["role_id"] > 2) {
    echo $_GET['id'] != $_SESSION["supplier"]["id"] ? header('location:./?pages=car-type/list') : '';
}
?>
                ...
                jqForm.validate({
                    rules: {
                        'name': {
                            ...
                            regex: /^[a-zA-Z0-9]/,
                            remote: {
                                url: "pages/car-type/function/check-name.php",
                                type: "post",
                                data: {
                                    car_type_id: function() {
                                        return $("#car_type_id").val();
                                    },
                                    category: function() {
                                        return $("#category").val();
                                    }
                    ...
                    submitHandler: function(form) {
                        ...
                        $.ajax({
                            url: "pages/car-type/function/edit.php",
                            type: "POST",
