...
<body class="vertical-layout vertical-menu-modern navbar-floating footer-static menu-collapsed pace-done" data-open="click" data-menu="vertical-menu-modern" data-col="">
    ...
    <?php
    $columntarget = $_SESSION["supplier"]["role_id"] == 1 || $_SESSION["supplier"]["role_id"] == 2 ? '3' : '3';
    ?>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            $('.product-list-table').DataTable({
                ...
                buttons: [{
                    ...
                    action: function(api, node, config) {
                        window.location.href = './?pages=tour/create';
                    }
                }],
                language: {
                    paginate: {
            ...
            var jqForm = $('#product-search-form'),
                picker = $('#dob'),
            ...
            jqForm.on("submit", function(e) {
                ...
                $.ajax({
                    url: "pages/tour/function/search.php",
                    type: "POST",
                    data: serializedData + "&action=search",
                    success: function(response) {
                        if (response != false) {
                            $("#product-search-table").html(response);
