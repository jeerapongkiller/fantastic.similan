<head>
    ...
    <title>Driver - <?php echo $main_title; ?></title>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('.driver-list-table').DataTable({
                ...
                buttons: [{
                    ...
                    action: function(api, node, config) {
                        window.location.href = './?pages=driver/create';
                    }
                }],
                language: {
                    paginate: {
            ...
            jqForm.on("submit", function(e) {
                ...
                $.ajax({
                    url: "pages/driver/function/search.php",
                    type: "POST",
                    data: serializedData + "&action=search",
                    success: function(response) {
                        if (response != false) {
                            $("#driver-search-table").html(response);
