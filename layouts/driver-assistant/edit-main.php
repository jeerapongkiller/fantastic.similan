<head>
    ...
    <title>Driver Assistant - <?php echo $main_title; ?></title>
...
<body class="vertical-layout vertical-menu-modern navbar-floating footer-static menu-collapsed pace-done" data-open="click" data-menu="vertical-menu-modern" data-col="">
    ...
    <script type="text/javascript">
        // Ajax Delete Driver Assistant
        // --------------------------------------------------------------------
        function deleteDriverAssistant(driver_ass_id) {
            Swal.fire({
                title: 'Are you sure?',
                ...
                if (result.value) {
                    $.ajax({
                        url: "pages/driver-assistant/function/delete.php",
                        type: "POST",
                        data: {
                            driver_ass_id: driver_ass_id,
                            action: 'delete'
                        },
                        success: function(response) {
                            if (response != false) {
                                Swal.fire({
                                    ...
                                    location.href = './?pages=driver-assistant/list';
                                });
                            } else {
                                Swal.fire({
                                    icon: 'error',
        ...
        $(document).ready(function() {
            var jqForm = $('#driver-assistant-edit-form'),
                ...
                jqForm.validate({
                    rules: {
                        'id_card': {
                            ...
                            remote: {
                                url: "pages/driver-assistant/function/check-id-card.php",
                                type: "post",
                                data: {
                                    driver_ass_id: function() {
                                        return $("#driver_ass_id").val();
                                    }
                                }
                            }
                        },
                    ...
                    submitHandler: function(form) {
                        ...
                        $.ajax({
                            url: "pages/driver-assistant/function/edit.php",
                            type: "POST",
                            processData: false,
                            contentType: false,
                            data: formData,
