...
<body class="vertical-layout vertical-menu-modern navbar-floating footer-static menu-collapsed pace-done" data-open="click" data-menu="vertical-menu-modern" data-col="">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            $('.quotation-list-table').DataTable({
                ...
                buttons: [{
                    ...
                    action: function(api, node, config) {
                        window.location.href = './?pages=quotation/create';
                    }
                }],
                language: {
                    paginate: {
            ...
            var jqForm = $('#quotation-search-form'),
                picker = $('.date-picker'),
            ...
            jqForm.on("submit", function(e) {
                ...
                $.ajax({
                    url: "pages/quotation/function/search.php",
                    type: "POST",
                    data: serializedData + "&action=search",
                    success: function(response) {
                        if (response != false) {
                            $("#quotation-search-table").html(response);
