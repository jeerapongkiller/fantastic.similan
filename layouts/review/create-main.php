<head>
    ...
    <title>Captain - <?php echo $main_title; ?></title>
...
<body class="vertical-layout vertical-menu-modern navbar-floating footer-static menu-collapsed pace-done" data-open="click" data-menu="vertical-menu-modern" data-col="">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            var jqForm = $('#captain-create-form'),
                ...
                jqForm.validate({
                    rules: {
                        'id_card': {
                            ...
                            regex: /^[0-9/]{13,13}$/,
                            remote: {
                                url: "pages/captain/function/check-id-card.php",
                                type: "post"
                            }
                        },
                        'first_name': {
                    ...
                    submitHandler: function(form) {
                        ...
                        $.ajax({
                            url: "pages/captain/function/create.php",
                            type: "POST",
                            processData: false,
                            contentType: false,
                            data: formData,
                            success: function(response) {
                                if (response != false && response > 0) {
                                    Swal.fire({
                                        ...
                                        if (isConfirm) {
                                            window.location.href = './?pages=captain/edit&id=' + response; // refresh page
                                        }
                                    });
                                } else {
                                    Swal.fire({
