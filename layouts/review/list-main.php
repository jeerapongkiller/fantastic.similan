<head>
    ...
    <title>Review - <?php echo $main_title; ?></title>
    ...
    <script type="text/javascript">
        ...
        function deleteReview(review_id) {
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        url: "pages/review/function/delete.php",
                        type: "POST",
                        data: {
                            review_id: review_id,
                            action: 'delete'
                        ...
                        success: function(response) {
                            if (response != false) {
                                Swal.fire({
                                    ...
                                    location.href = './?pages=review/list';
                                });
                            } else {
                                Swal.fire({
                                    icon: 'error',
        ...
        $(document).ready(function() {
            $('.review-list-table').DataTable({
                ...
                buttons: [{
                    ...
                    action: function(api, node, config) {
                        window.location.href = './?pages=review/create';
                    }
                }],
                language: {
                    paginate: {
            ...
            jqForm.on("submit", function(e) {
                ...
                $.ajax({
                    url: "pages/review/function/search.php",
                    type: "POST",
                    data: serializedData + "&action=search",
                    success: function(response) {
                        if (response != false) {
                            $("#review-search-table").html(response);
