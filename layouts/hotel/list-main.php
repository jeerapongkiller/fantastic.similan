<head>
    ...
    <title>Hotel - <?php echo $main_title; ?></title>
    ...
    <!-- BEGIN: Custom CSS-->
    <link href="app-assets/fonts/fontawesome/css/all.css" rel="stylesheet">
    <!-- END: Custom CSS-->
...
<body class="vertical-layout vertical-menu-modern navbar-floating footer-static menu-collapsed pace-done" data-open="click" data-menu="vertical-menu-modern" data-col="">
    ...
    <script defer src="app-assets/fonts/fontawesome/js/all.js"></script>
    <!-- END: Page Vendor JS-->
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('.hotel-list-table').DataTable({
                ...
                buttons: [{
                    ...
                    action: function(api, node, config) {
                        window.location.href = './?pages=hotel/create';
                    }
                }],
                language: {
                    paginate: {
            ...
            jqForm.on("submit", function(e) {
                ...
                $.ajax({
                    url: "pages/hotel/function/search.php",
                    type: "POST",
                    data: serializedData + "&action=search",
                    success: function(response) {
                        if (response != false) {
                            $("#hotel-search-table").html(response);
