...
if (isset($_SESSION["supplier"]["role_id"])) {
    echo $_SESSION["supplier"]["role_id"] > 2 ? header('location:./?pages=boat-type/list') : '';
}
?>
...
<body class="vertical-layout vertical-menu-modern navbar-floating footer-static menu-collapsed pace-done" data-open="click" data-menu="vertical-menu-modern" data-col="">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            var jqForm = $('#boat-type-create-form'),
                picker = $('#dob'),
                ...
                jqForm.validate({
                    rules: {
                        'name': {
                            ...
                            regex: /^[a-zA-Z0-9]/,
                            remote: {
                                url: "pages/boat-type/function/check-name.php",
                                type: "post"
                            }
                        },
                    },
                    ...
                    submitHandler: function(form) {
                        ...
                        $.ajax({
                            url: "pages/boat-type/function/create.php",
                            type: "POST",
                            ...
                            success: function(response) {
                                if (response != false && response > 0) {
                                    Swal.fire({
                                        ...
                                        if (isConfirm) {
                                            window.location.href = './?pages=boat-type/edit&id=' + response; // refresh page
                                        }
                                    });
                                } else {
                                    Swal.fire({
