...
if (isset($_SESSION["supplier"]["id"]) && $_SESSION["supplier"]["role_id"] > 2) {
    echo $_GET['id'] != $_SESSION["supplier"]["id"] ? header('location:./?pages=boat-type/list') : '';
}
?>
...
<body class="vertical-layout vertical-menu-modern navbar-floating footer-static menu-collapsed pace-done" data-open="click" data-menu="vertical-menu-modern" data-col="">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            var jqForm = $('#boat-type-edit-form'),
                picker = $('#dob'),
            ...
            if (jqForm.length) {
                ...
                jqForm.validate({
                    rules: {
                        'name': {
                            ...
                            remote: {
                                ...
                                type: "post",
                                data: {
                                    boat_type_id: function() {
                                        return $("#boat_type_id").val();
                                    }
                                }
                            }
                        },
                    ...
                    submitHandler: function(form) {
                        ...
                        $.ajax({
                            url: "pages/boat-type/function/edit.php",
                            type: "POST",
