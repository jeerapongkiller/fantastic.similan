...
<body class="vertical-layout vertical-menu-modern navbar-floating footer-static menu-collapsed pace-done" data-open="click" data-menu="vertical-menu-modern" data-col="">
    ...
    <!-- BEGIN: Page JS-->
    <script type="text/javascript">// Ajax Delete place
        // --------------------------------------------------------------------
        function deletePlace(place_id) {
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        url: "pages/place/function/delete.php",
                        type: "POST",
                        data: {
                            place_id: place_id,
                            action: 'delete'
                        ...
                        success: function(response) {
                            if (response != false) {
                                Swal.fire({
                                    ...
                                    location.href = './?pages=place/list';
                                });
                            } else {
                                Swal.fire({
                                    icon: 'error',
            ...
            if (jqForm.length) {
                ...
                jqForm.validate({
                    ...
                    submitHandler: function(form) {
                        ...
                        $.ajax({
                            url: "pages/place/function/edit.php",
                            type: "POST",
                            processData: false,
                            contentType: false,
                            data: formData,
