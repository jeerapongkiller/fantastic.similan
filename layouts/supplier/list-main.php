<head>
    ...
    <title>Supplier - <?php echo $main_title; ?></title>
    ...
    <script type="text/javascript">
        ...
        function deleteSupplier(supplier_id) {
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        url: "pages/supplier/function/delete.php",
                        type: "POST",
                        data: {
                        ...
                        success: function(response) {
                            if (response != false) {
                                Swal.fire({
                                    ...
                                    location.href = './?pages=supplier/list';
                                });
                            } else {
                                Swal.fire({
                                    icon: 'error',
        ...
        $(document).ready(function() {
            $('.supplier-list-table').DataTable({
                ...
                buttons: [{
                    ...
                    action: function(api, node, config) {
                        window.location.href = './?pages=supplier/create';
                    }
                }],
                language: {
                    paginate: {
            ...
            var jqForm = $('#supplier-search-form'),
                picker = $('#dob'),
            ...
            jqForm.on("submit", function(e) {
                ...
                $.ajax({
                    url: "pages/supplier/function/search.php",
                    type: "POST",
                    data: serializedData + "&action=search",
                    success: function(response) {
                        if (response != false) {
                            $("#supplier-search-table").html(response);
