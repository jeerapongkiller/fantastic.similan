...
if (isset($_SESSION["supplier"]["role_id"])) {
    echo $_SESSION["supplier"]["role_id"] > 2 ? header('location:./?pages=branch/list') : '';
}
?>
            ...
            if (jqForm.length) {
                ...
                jqForm.validate({
                    ...
                    submitHandler: function(form) {
                        ...
                        $.ajax({
                            url: "pages/branch/function/create.php",
                            type: "POST",
                            ...
                            success: function(response) {
                                if (response != false && response > 0) {
                                    Swal.fire({
                                        ...
                                        if (isConfirm) {
                                            window.location.href = './?pages=branch/edit&id=' + response; // refresh page
                                        }
                                    });
                                } else {
                                    Swal.fire({
