...
if (isset($_SESSION["supplier"]["id"]) && $_SESSION["supplier"]["role_id"] > 2) {
    echo $_GET['id'] != $_SESSION["supplier"]["id"] ? header('location:./?pages=branch/list') : '';
}
?>
    ...
    <script type="text/javascript">
        ...
        function deleteBranch(branch_id) {
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        url: "pages/branch/function/delete.php",
                        type: "POST",
                        data: {
                            branch_id: branch_id,
                            action: 'delete'
                        ...
                        success: function(response) {
                            if (response != false) {
                                Swal.fire({
                                    ...
                                    location.href = './?pages=branch/list';
                                });
                            } else {
                                Swal.fire({
                                    icon: 'error',
            ...
            if (jqForm.length) {
                ...
                jqForm.validate({
                    ...
                    submitHandler: function(form) {
                        ...
                        $.ajax({
                            url: "pages/branch/function/edit.php",
                            type: "POST",
