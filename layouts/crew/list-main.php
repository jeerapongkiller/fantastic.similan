<head>
    ...
    <title>Crew - <?php echo $main_title; ?></title>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('.crew-list-table').DataTable({
                ...
                buttons: [{
                    ...
                    action: function(api, node, config) {
                        window.location.href = './?pages=crew/create';
                    }
                }],
                language: {
                    paginate: {
            ...
            jqForm.on("submit", function(e) {
                ...
                $.ajax({
                    url: "pages/crew/function/search.php",
                    type: "POST",
                    data: serializedData + "&action=search",
                    success: function(response) {
                        if (response != false) {
                            $("#crew-search-table").html(response);
