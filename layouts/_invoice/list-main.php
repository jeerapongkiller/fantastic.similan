        ...
        function modal_page_invoice(type) {
            if (type == 'next') {
                ...
                if (bo_id != '') {
                    ...
                    document.getElementById('div-select-invoice-date').hidden = true;
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            if (response != 'false') {
                                ...
                                $('#currency, #vat, #branch, #bank_account').select2();
                ...
                document.getElementById('div-select-invoice-date').hidden = false;
