...
if (isset($_SESSION["supplier"]["id"]) && $_SESSION["supplier"]["role_id"] > 2) {
    echo $_GET['id'] != $_SESSION["supplier"]["id"] ? header('location:./?pages=boat/list') : '';
}
?>
...
<head>
    ...
    <title>Boats - <?php echo $main_title; ?></title>
    ...
    <script type="text/javascript">
        ...
        function deleteBoat(boat_id) {
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        url: "pages/boat/function/delete.php",
                        type: "POST",
                        data: {
                            boat_id: boat_id,
                            action: 'delete'
        ...
        $(document).ready(function() {
            ...
            if (jqForm.length) {
                ...
                jqForm.validate({
                    rules: {
                        'name': {
                            ...
                            regex: /^[a-zA-Z0-9#]/,
                            remote: {
                                url: "pages/boat/function/check-name.php",
                                type: "post",
                                data: {
                                    boat_id: function() {
                                        return $("#boat_id").val();
                        ...
                        'refcode': {
                            regex: /^[a-zA-Z0-9ก-ฮ#]/,
                            remote: {
                                url: "pages/boat/function/check-refcode.php",
                                type: "post",
                                data: {
                                    boat_id: function() {
                                        return $("#boat_id").val();
                    ...
                    messages: {
                        ...
                        'refcode': {
                            remote: "This ref code is already taken! Try another."
                        }
                    },
                    submitHandler: function(form) {
                        ...
                        $.ajax({
                            url: "pages/boat/function/edit.php",
                            type: "POST",
                ...
                // Change boat category
                $('#category').change(function() {
                    var serializedData = $(jqForm).serialize();
                    $.ajax({
                        url: "pages/boat/function/change-category.php",
                        type: "POST",
                        data: serializedData + "&action=create",
                        success: function(response) {
                            $('#div-type').html(response);
