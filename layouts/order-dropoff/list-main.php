    ...
    <script type="text/javascript">
        $(document).ready(function() {
            var jqFormManage = $('#manage-search-form'),
                ...
                dragAreaC = $('#multiple-list-group-c'),
                picker = $('#dob'),
            ...
            if (dragAreaC.length) {
                dragula([document.getElementById('multiple-list-group-c'), document.getElementById('multiple-list-group-d')])
                    .on('drag', function(el) {
                        // add 'is-moving' class to element being dragged
                    })
                    .on('dragend', function(el) {
            ...
            jqFormManage.on("submit", function(e) {
                ...
                $.ajax({
                    url: "pages/order-dropoff/function/search-manage.php",
                    type: "POST",
            ...
            jqFormDriver.on("submit", function(e) {
                var serializedData = $(this).serialize();
                $.ajax({
                    url: "pages/order-dropoff/function/search-driver.php",
                    type: "POST",
                    data: serializedData + "&action=search",
                    success: function(response) {
                        if (response != 'false') {
        ...
        function modal_order_driver(order_id, date, date_text, data_head, data_body) {
            ...
            formData.append('date_travel_manage', date);
            $.ajax({
                url: "pages/order-dropoff/function/search-manage.php",
                type: "POST",
                processData: false,
        ...
        function fun_search_period_manage() {
            var search_period = document.getElementById('search_manage_period').value;
            document.getElementById('div-travel-manage').hidden = search_period == 'custom' ? false : true;
            ...
            let currentDate = search_period == 'custom' ? document.getElementById('date_travel_manage').value : `${year}-${month}-${day}`;

            $('#date_travel_manage').flatpickr({
                onReady: function(selectedDates, dateStr, instance) {
                    if (instance.isMobile) {
                        $(instance.mobileInput).attr('step', null);
                    }
        ...
        function add_manage_booking() {
            ...
            var date_travel = document.getElementById("date_travel_manage");
            ...
            $.ajax({
                url: "pages/order-dropoff/function/" + position,
                type: "POST",
                processData: false,
                contentType: false,
                data: formData,
        ...
        function edit_manage_booking(type) {
            ...
            $.ajax({
                url: "pages/order-dropoff/function/edit-manage.php",
                type: "POST",
                processData: false,
                contentType: false,
                data: formData,
        ...
        function deleteManage() {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    formData.append('btr_id', JSON.stringify(btr));
                    $.ajax({
                        url: "pages/order-dropoff/function/delete-manage.php",
                        type: "POST",
                        processData: false,
                        contentType: false,
                        data: formData,
        ...
        function modal_manage_transfer() {
            ...
            $.ajax({
                url: "pages/order-dropoff/function/search-manage-transfer.php",
                type: "POST",
                processData: false,
                contentType: false,
                data: formData,
        ...
        function add_header_transfer() {
            ...
            if (manage_id.value > 0) {
                ...
                formData.append('action', 'search');
                formData.append('manage_id', manage_id.value);
                formData.append('date_travel_manage', date_travel.value);
