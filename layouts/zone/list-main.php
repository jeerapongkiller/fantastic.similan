<head>
    ...
    <title>Zone - <?php echo $main_title; ?></title>
    ...
    <script type="text/javascript">
        ...
        function deletePlace(zone_id) {
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        url: "pages/zone/function/delete.php",
                        type: "POST",
                        data: {
                            zone_id: zone_id,
                            action: 'delete'
        ...
        $(document).ready(function() {
            ...
            jqForm.on("submit", function(e) {
                ...
                $.ajax({
                    url: "pages/zone/function/search.php",
                    type: "POST",
