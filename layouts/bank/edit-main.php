...
if (isset($_SESSION["supplier"]["id"]) && $_SESSION["supplier"]["role_id"] > 2) {
    echo $_GET['id'] != $_SESSION["supplier"]["id"] ? header('location:./?pages=bank/list') : '';
}
?>
    ...
    <script type="text/javascript">
        ...
        function deleteBank(bank_id) {
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        url: "pages/bank/function/delete.php",
                        type: "POST",
                        data: {
                            bank_id: bank_id,
                            action: 'delete'
            ...
            if (jqForm.length) {
                ...
                jqForm.validate({
                    ...
                    submitHandler: function(form) {
                        ...
                        $.ajax({
                            url: "pages/bank/function/edit.php",
                            type: "POST",
