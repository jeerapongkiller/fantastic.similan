    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('.bank-list-table').DataTable({
                ...
                buttons: [{
                    ...
                    action: function(api, node, config) {
                        window.location.href = './?pages=bank/create';
                    }
                }],
                language: {
                    paginate: {
            ...
            jqForm.on("submit", function(e) {
                ...
                $.ajax({
                    url: "pages/bank/function/search.php",
                    type: "POST",
                    data: serializedData + "&action=search",
                    success: function(response) {
                        if (response != false) {
                            $("#bank-search-table").html(response);
