...
if (isset($_SESSION["supplier"]["role_id"])) {
    echo $_SESSION["supplier"]["role_id"] > 2 ? header('location:./?pages=bank/list') : '';
}
?>
...
<head>
    ...
    <title>Bank - <?php echo $main_title; ?></title>
            ...
            if (jqForm.length) {
                ...
                jqForm.validate({
                    ...
                    submitHandler: function(form) {
                        ...
                        $.ajax({
                            url: "pages/bank/function/create.php",
                            type: "POST",
                            ...
                            success: function(response) {
                                if (response != false && response > 0) {
                                    Swal.fire({
                                        ...
                                        if (isConfirm) {
                                            window.location.href = './?pages=bank/edit&id=' + response; // refresh page
                                        }
                                    });
                                } else {
                                    Swal.fire({
