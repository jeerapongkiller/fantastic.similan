...
<body class="vertical-layout vertical-menu-modern navbar-floating footer-static menu-collapsed pace-done" data-open="click" data-menu="vertical-menu-modern" data-col="">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            $('.bank-account-list-table').DataTable({
                "searching": false,
                order: [
                    [0, 'asc']
                ],
                ...
                buttons: [{
                    ...
                    action: function(api, node, config) {
                        window.location.href = './?pages=bank-account/create';
                    }
                }],
                language: {
                    paginate: {
            ...
            var jqForm = $('#bank-account-search-form'),
                picker = $('#dob'),
            ...
            jqForm.on("submit", function(e) {
                ...
                $.ajax({
                    url: "pages/bank-account/function/search.php",
                    type: "POST",
                    data: serializedData + "&action=search",
                    success: function(response) {
                        if (response != false) {
                            $("#bank-account-search-table").html(response);
