...
if (isset($_SESSION["supplier"]["id"]) && $_SESSION["supplier"]["role_id"] > 2) {
    echo $_GET['id'] != $_SESSION["supplier"]["id"] ? header('location:./?pages=bank-account/list') : '';
}
?>
    ...
    <script type="text/javascript">
        ...
        function deleteAccount(account_id) {
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        url: "pages/bank-account/function/delete.php",
                        type: "POST",
                        data: {
                        ...
                        success: function(response) {
                            if (response != false) {
                                Swal.fire({
                                    ...
                                    location.href = './?pages=bank-account/list';
                                });
                            } else {
                                Swal.fire({
                                    icon: 'error',
        ...
        $(document).ready(function() {
            var jqForm = $('#bank-account-edit-form'),
                picker = $('#dob'),
            ...
            if (jqForm.length) {
                ...
                jqForm.validate({
                    ...
                    submitHandler: function(form) {
                        ...
                        $.ajax({
                            url: "pages/bank-account/function/edit.php",
                            type: "POST",
